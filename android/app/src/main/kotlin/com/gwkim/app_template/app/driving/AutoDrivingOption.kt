...
class AutoDrivingOption @Inject constructor(@ApplicationContext private val context: Context) {
    companion object {
        val AUTO_START_TYPE = stringPreferencesKey("auto_start_type")
        val BEACON_ADDRESS = stringPreferencesKey("beacon_address")
        val DRIVING_START_CONDITION = stringPreferencesKey("driving_start_condition")
        val DRIVING_END_CONDITION = stringPreferencesKey("driving_end_condition")
    }
