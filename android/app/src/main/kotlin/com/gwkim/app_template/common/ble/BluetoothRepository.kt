...
import kr.co.dpub.dpubadd.common.ble.util.BluetoothUtils
import kr.co.dpub.dpubadd.common.ble.util.Event
import java.util.*
...
//                .setServiceUuid(ParcelUuid(UUID.fromString(SERVICE_STRING)))
                .setDeviceAddress("C3:00:00:1C:65:91")
                .build()
        ...
        Timer("SettingUp", false).schedule(10000) { stopScan() }
    }
    ...
    private val BLEScanCallback: ScanCallback = object : ScanCallback() {
        override fun onScanResult(callbackType: Int, result: ScanResult) {
            ...
            Log.e("scanCallback", "scanSuccess")
            stopScan()
